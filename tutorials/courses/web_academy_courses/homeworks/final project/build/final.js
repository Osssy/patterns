...
var _dropdowns = __webpack_require__(330);

var _readMore = __webpack_require__(331);

var _modalShelf = __webpack_require__(332);
...
function readMore() {
	...
	var btnText = document.querySelector(".more-link");
...
exports.modalShelf = modalShelf;
//modal book-shelf!

function modalShelf() {
    var modal = document.querySelector(".modal-mask");
    var btn = document.querySelector(".book__button");
    var span = document.querySelector(".book-page-shelf__close");
